...
g++ $obj_files_path/main.o $obj_files_path/Lexer.o $obj_files_path/Parser.o $obj_files_path/Emitter.o $obj_files_path/PythonEmitter.o $obj_files_path/CppEmitter.o
